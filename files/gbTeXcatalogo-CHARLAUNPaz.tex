...
\noindent\legales{Formato: \textbf{14x20cm}}\\
\noindent\legales{Páginas: \textbf{224}}\\
...
\begin{minipage}{11cm}
\noindent \cabecera{Colección {\color{color2}\textbf{Morral de apuntes}}}\\
\noindent \cabecera{Dirigida por \textbf{Desconocida}}\\
\end{minipage}
\end{textblock*}
...
\begin{minipage}{11cm}
\noindent \texto{Resumen en idioma principal}
\end{minipage}
\end{textblock*}
...
\begin{minipage}{18cm}
\centering
\url{https://edunpaz.unpaz.edu.ar/OMP/index.php/edunpaz/catalog/book/108}
\end{minipage}
\end{textblock*}
\end{document}
